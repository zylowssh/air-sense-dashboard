# ⚡ Guide de Démarrage Rapide - Référence Rapide

Guide de référence rapide du Tableau de Bord Aerium Qualité de l'Air.

[English Version](QUICKSTART.md) | **Version Française**
...
### Docker (Optional)
```bash
docker build -t aerium-api .
docker run -p 5000:5000 aerium-api
```

## 📚 Documentation Complète

- **README_FR.md** - Vue d'ensemble du projet
- **FEATURES_FR.md** - Toutes les fonctionnalités détaillées
- **backend/README.md** - Référence API complète
...
- Lire FEATURES_FR.md pour details complètes
- Vérifier README_FR.md pour instructions d'installation
